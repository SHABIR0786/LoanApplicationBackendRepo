...
{
    public abstract class LoanManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LoanManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LoanManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LoanManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<LoanManagementDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<LoanManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LoanManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LoanManagementDbContext, Task<T>> func)
        {
            T result;
